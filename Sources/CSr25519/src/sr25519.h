 ...
 *
 * * secret_out: 64 bytes, pre-allocated output buffer of 64 bytes
 * * secret_ptr: ed25519 key representation - input buffer of 64 bytes
 *
 */
 ...
 *
 * * secret_out: 64 bytes, pre-allocated output buffer of 64 bytes
 * * secret_ptr: sr25519 key representation - input buffer of 64 bytes
 *
 */
